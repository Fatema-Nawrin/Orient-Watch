    ...
    return (
        <div>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mt-12 justify-items-center'>
                <div>
                    <h3 className='font-bold text-lg text-purple-700 mb-6'>Month Wise Sell</h3>
                ...
                <div>
                    <h3 className='font-bold text-lg text-purple-700 mb-6'>Investment Vs Revenue</h3>
                ...
                <div>
                    <h3 className='font-bold text-lg lg:mt-8 text-purple-700 mb-6'>Investment Vs Revenue</h3>
                ...
                <div>
                    <h3 className='font-bold text-lg md:mt-8 text-purple-700 '>Investment Vs Revenue</h3>
