    ...
    return (
        <div className='mx-10'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mt-12 justify-items-center'>
                ...
                <div>
                    <h3 className='font-bold text-lg text-center text-gray-600 mb-6'>Investment Vs Revenue</h3>
                ...
                <div>
                    <h3 className='font-bold text-center text-lg lg:mt-8 text-gray-600 mb-6'>Investment Vs Revenue</h3>
                ...
                <div>
                    <h3 className='font-bold text-center text-lg md:mt-8 text-gray-600 '>Investment Vs Revenue</h3>
